        ...
        <>
            ...
            <main>
                <div className="profile-wrapper">
                    <div className="profile-header" id="et-al">
                        <img 
                            className="profile-portrait" 
                            src={EtAlPortrait} 
                            alt="a middle aged Caucasian man with long wavy brown hair and greying beard" 
                        />
                        <h2>Et Al</h2>
                    </div>
                    ...
                    <div className="profile-header" id="lester-girdle">
                        <img 
                            className="profile-portrait" 
                            src={LesterGirdlePortrait} 
                            alt="a 30 something Caucasian man with a receding hairline and glasses" 
                        />
                        <h2>Lester Girdle</h2>
                    </div>
                    <div className="profile-text">
                    ...
                    <div className="profile-header" id="pieter-klykbeit">
                        <img 
                            className="profile-portrait" 
                            src={PieterKlykbeitPortrait} 
                            alt="a half Caucasian half African man in his 40s with a thinning hairline" 
                        />
                    ...
                    <div className="profile-header" id="alexa-turing">
                        <img 
                            className="profile-portrait" 
                            src={AlexaTuringPortrait} 
                            alt="a young smiling Chinese-American woman wearing glasses" 
                        />
                        <h2>Alexa Turing</h2>
                    </div>
                    <div className="profile-text">
